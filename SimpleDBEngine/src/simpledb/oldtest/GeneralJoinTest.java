...
public class GeneralJoinTest {
    public static void main(String[] args) {
        try {
            ...
            OldTestUtil.executeSelectQuery(qry, tx, planner, studentAndDeptAndCourse);
            ...
            OldTestUtil.executeSelectQuery(qry, tx, planner, studentAndEnrollAndSection);
            ...
            OldTestUtil.executeSelectQuery(qry, tx, planner, studentAndEnrollAndSectionAndCourse);
            ...
            OldTestUtil.executeSelectQuery(qry, tx, planner, allFiveTables);
            ...
            OldTestUtil.executeSelectQuery(qry, tx, planner, snameAndGrade);
        }
        catch(Exception e) {
            e.printStackTrace();
        }
